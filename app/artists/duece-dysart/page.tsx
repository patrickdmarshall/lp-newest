...
export default function DueceDysartPage() {
  const artist = {
    name: "Duece Dysart",
    location: "Columbus, OH",
    genres: ["Hip Hop"],
    bio: "Duece Dysart is a dynamic hip-hop artist from Columbus, Ohio, known for his energetic performances and authentic street narratives. With a style that combines classic hip-hop elements with modern production, Duece continues to make his mark in the Columbus music scene.",
    profile_picture: "/images/duecexdysart.webp",
    social_links: [
      {
        platform: "Spotify",
        url: "https://open.spotify.com/artist/duece-dysart",
        followers: "1.9K",
      },
      {
        platform: "Instagram",
        url: "https://www.instagram.com/duecedysart",
        followers: "3.4K",
      },
    ],
  }
          ...
          <Card className="bg-navy-light border-navy">
            ...
            <CardContent>
              <ul className="text-gray-300 space-y-2">
                <li>• Columbus Hip-Hop Showcase - Featured Artist</li>
                <li>• AR Music Bar - Live Performance</li>
                <li>• Underground Hip-Hop Night - Headliner</li>
              </ul>
            </CardContent>
          </Card>
