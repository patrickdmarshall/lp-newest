...
export default function VitruvianSoulPage() {
  const artist = {
    name: "Vitruvian Soul",
    location: "Columbus, OH",
    genres: ["Pop"],
    bio: "Vitruvian Soul is an innovative pop artist from Columbus, Ohio, known for blending contemporary pop with philosophical themes and artistic expression. Their music explores the intersection of human experience and artistic creation, creating a unique and thought-provoking sound.",
    profile_picture: "/images/vitruvian-soul.jpg",
    social_links: [
      {
        platform: "Spotify",
        url: "https://open.spotify.com/artist/vitruvian-soul",
        followers: "2.3K",
      },
      {
        platform: "Instagram",
        url: "https://www.instagram.com/vitruviansoul",
        followers: "4.5K",
      },
    ],
  }
          ...
          <Card className="bg-navy-light border-navy">
            ...
            <CardContent>
              <ul className="text-gray-300 space-y-2">
                <li>• Art & Music Festival Columbus - Featured Performance</li>
                <li>• The Basement - Conceptual Show</li>
                <li>• Pop Showcase Series - Headliner</li>
              </ul>
            </CardContent>
          </Card>
