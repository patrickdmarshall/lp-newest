...
export default function HightopHangoverPage() {
  const artist = {
    name: "Hightop Hangover",
    location: "Columbus, OH",
    genres: ["Alternative"],
    bio: "Hightop Hangover is an alternative rock band from Columbus, Ohio, known for their energetic performances and catchy melodies. With a sound that combines alternative rock with pop sensibilities, they create music that's both accessible and artistically compelling.",
    profile_picture: "/images/hightop-hangover.jpeg",
    social_links: [
      {
        platform: "Spotify",
        url: "https://open.spotify.com/artist/hightop-hangover",
        followers: "3.8K",
      },
      {
        platform: "Instagram",
        url: "https://www.instagram.com/hightophangover",
        followers: "5.4K",
      },
    ],
  }
          ...
          <Card className="bg-navy-light border-navy">
            ...
            <CardContent>
              <ul className="text-gray-300 space-y-2">
                ...
                <li>• Columbus Alternative Festival - Supporting Act</li>
              </ul>
            </CardContent>
          </Card>
