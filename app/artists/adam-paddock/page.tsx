...
export default function AdamPaddockPage() {
  const artist = {
    name: "Adam Paddock",
    location: "Columbus, OH",
    genres: ["Pop"],
    bio: "Adam Paddock is a talented pop artist from Columbus, Ohio, known for his catchy melodies and heartfelt lyrics. With a sound that combines contemporary pop sensibilities with authentic storytelling, Adam continues to build a dedicated following in the local music scene.",
    profile_picture: "/images/adam-paddock-new.jpeg",
    social_links: [
      {
        platform: "Spotify",
        url: "https://open.spotify.com/artist/adam-paddock",
        followers: "3.1K",
      },
      {
        platform: "Instagram",
        url: "https://www.instagram.com/adampaddock",
        followers: "5.7K",
      },
    ],
  }
          ...
          <Card className="bg-navy-light border-navy">
            ...
            <CardContent>
              <ul className="text-gray-300 space-y-2">
                <li>• Newport Music Hall - Opening Act</li>
                <li>• Columbus Pop Festival - Featured Artist</li>
                <li>• AR Music Bar - Acoustic Set</li>
              </ul>
            </CardContent>
          </Card>
