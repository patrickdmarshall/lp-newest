...
export default function SurrenderTheGhostPage() {
  const artist = {
    name: "Surrender The Ghost",
    location: "Columbus, OH",
    genres: ["Rock", "Emo"],
    bio: "Surrender The Ghost is an emotionally charged rock band from Columbus, Ohio, known for their powerful blend of rock and emo influences. With intense performances and deeply personal lyrics, they create music that connects with audiences on a profound emotional level.",
    profile_picture: "/images/surrender-the-ghost.jpg",
    social_links: [
      {
        platform: "Spotify",
        url: "https://open.spotify.com/artist/surrender-the-ghost",
        followers: "4.2K",
      },
      {
        platform: "Instagram",
        url: "https://www.instagram.com/surrendertheghost",
        followers: "6.8K",
      },
    ],
  }
          ...
          <Card className="bg-navy-light border-navy">
            ...
            <CardContent>
              <ul className="text-gray-300 space-y-2">
                <li>• Kemba Live - Supporting Act</li>
                <li>• Newport Music Hall - Rock Night Headliner</li>
                <li>• Columbus Emo Festival - Featured Performance</li>
              </ul>
            </CardContent>
          </Card>
