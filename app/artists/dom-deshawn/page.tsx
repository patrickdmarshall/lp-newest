...
export default function DomDeshawnPage() {
  const artist = {
    name: "Dom Deshawn",
    location: "Columbus, OH",
    genres: ["Hip Hop", "R&B"],
    bio: "Dom Deshawn is a versatile artist from Columbus, Ohio, seamlessly blending hip-hop and R&B to create a unique sound that resonates with audiences. Known for his smooth vocals and compelling storytelling, Dom continues to establish himself as a rising talent in the music industry.",
    profile_picture: "/images/dom-deshawn-updated.jpg",
    social_links: [
      {
        platform: "Spotify",
        url: "https://open.spotify.com/artist/dom-deshawn",
        followers: "2.5K",
      },
      {
        platform: "Instagram",
        url: "https://www.instagram.com/domdeshawn",
        followers: "4.1K",
      },
    ],
  }
          ...
          <Card className="bg-navy-light border-navy">
            ...
            <CardContent>
              <ul className="text-gray-300 space-y-2">
                <li>• The Basement - Featured Artist</li>
                <li>• AR Music Bar - Live Performance</li>
                <li>• Columbus R&B Night - Headliner</li>
              </ul>
            </CardContent>
          </Card>
