            ...
            <div className="container px-4 md:px-6">
              <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-4 mb-8">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-orange-300 font-semibold text-lg">
                      Database Migration in Progress
                    </h3>
                    <p className="text-orange-200/80 text-sm">
                      We're currently migrating our database to improve
                      performance. All artist profiles will be visible again
