...
export default function KidsOfTheCinemaPage() {
  const artist = {
    name: "Kids of the Cinema",
    location: "Columbus, OH",
    genres: ["Math Rock", "Emo"],
    bio: "Kids of the Cinema is a math rock and emo band from Columbus, Ohio, known for their intricate compositions and emotional depth. Combining complex rhythms with heartfelt lyrics, they create music that's both technically impressive and emotionally resonant.",
    profile_picture: "/images/kids-of-the-cinema.jpg",
    social_links: [
      {
        platform: "Spotify",
        url: "https://open.spotify.com/artist/kids-of-the-cinema",
        followers: "3.6K",
      },
      {
        platform: "Instagram",
        url: "https://www.instagram.com/kidsofthecinema",
        followers: "5.2K",
      },
    ],
  }
          ...
          <Card className="bg-navy-light border-navy">
            ...
            <CardContent>
              <ul className="text-gray-300 space-y-2">
                <li>• The Basement - Math Rock Showcase</li>
                <li>• AR Music Bar - Featured Performance</li>
                <li>• Columbus Emo Festival - Supporting Act</li>
              </ul>
            </CardContent>
          </Card>
