...
export default function SarahCowanPage() {
  const artist = {
    name: "Sarah Cowan",
    location: "Columbus, OH",
    genres: ["Pop"],
    bio: "Sarah Cowan is a talented pop artist from Columbus, Ohio, known for her powerful vocals and captivating stage presence. With a sound that combines contemporary pop with classic influences, Sarah creates music that's both emotionally resonant and commercially appealing, establishing herself as a rising star in the pop scene.",
    profile_picture: "/images/sarah-cowan.jpeg",
    social_links: [
      {
        platform: "Spotify",
        url: "https://open.spotify.com/artist/sarah-cowan",
        followers: "4.9K",
      },
      {
        platform: "Instagram",
        url: "https://www.instagram.com/sarahcowan",
        followers: "7.6K",
      },
    ],
  }
          ...
          <Card className="bg-navy-light border-navy">
            ...
            <CardContent>
              <ul className="text-gray-300 space-y-2">
                <li>• Newport Music Hall - Pop Showcase</li>
                <li>• AR Music Bar - Featured Performance</li>
                <li>• Columbus Pop Festival - Rising Artist</li>
              </ul>
            </CardContent>
          </Card>
