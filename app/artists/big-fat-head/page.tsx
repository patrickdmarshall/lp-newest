...
export default function BigFatHeadPage() {
  const artist = {
    name: "Big Fat Head",
    location: "Columbus, OH",
    genres: ["Post Punk", "Rock"],
    bio: "Big Fat Head is an energetic post punk rock band from Columbus, Ohio, known for their raw sound and intense live performances. Combining classic punk energy with modern rock sensibilities, they deliver music that's both nostalgic and refreshingly contemporary.",
    profile_picture: "/images/big-fat-head.jpg",
    social_links: [
      {
        platform: "Spotify",
        url: "https://open.spotify.com/artist/big-fat-head",
        followers: "3.7K",
      },
      {
        platform: "Instagram",
        url: "https://www.instagram.com/bigfathead",
        followers: "5.1K",
      },
    ],
  }
          ...
          <Card className="bg-navy-light border-navy">
            ...
            <CardContent>
              <ul className="text-gray-300 space-y-2">
                <li>• The Basement - Punk Night Headliner</li>
                <li>• AR Music Bar - Live Performance</li>
                <li>• Columbus Punk Festival - Featured Act</li>
              </ul>
            </CardContent>
          </Card>
