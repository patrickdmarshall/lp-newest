...
export default function StillcastlePage() {
  const artist = {
    name: "Stillcastle",
    location: "Columbus, OH",
    genres: ["Alternative"],
    bio: "Stillcastle is an alternative rock band from Columbus, Ohio, known for their atmospheric sound and introspective lyrics. With a style that combines alternative rock with ambient elements, Stillcastle creates music that's both contemplative and powerful, resonating deeply with their audience.",
    profile_picture: "/images/stillcastle.jpeg",
    social_links: [
      {
        platform: "Spotify",
        url: "https://open.spotify.com/artist/stillcastle",
        followers: "2.9K",
      },
      {
        platform: "Instagram",
        url: "https://www.instagram.com/stillcastle",
        followers: "3.8K",
      },
    ],
  }
          ...
          <Card className="bg-navy-light border-navy">
            ...
            <CardContent>
              <ul className="text-gray-300 space-y-2">
                <li>• The Basement - Atmospheric Set</li>
                <li>• AR Music Bar - Featured Performance</li>
                <li>• Columbus Alternative Showcase - Supporting Act</li>
              </ul>
            </CardContent>
          </Card>
