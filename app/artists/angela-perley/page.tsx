...
export default function AngelaPerleyPage() {
  const artist = {
    name: "Angela Perley",
    location: "Columbus, OH",
    genres: ["Country", "Americana", "Rock"],
    bio: "Angela Perley is a versatile artist from Columbus, Ohio, seamlessly blending country, Americana, and rock influences to create a distinctive sound. Known for her powerful vocals and authentic storytelling, Angela has established herself as a prominent figure in the Columbus music scene.",
    profile_picture: "/images/angie.jpg",
    social_links: [
      {
        platform: "Spotify",
        url: "https://open.spotify.com/artist/angela-perley",
        followers: "5.8K",
      },
      {
        platform: "Instagram",
        url: "https://www.instagram.com/angelaperley",
        followers: "8.2K",
      },
    ],
  }
          ...
          <Card className="bg-navy-light border-navy">
            ...
            <CardContent>
              <ul className="text-gray-300 space-y-2">
                <li>• Newport Music Hall - Headliner</li>
                <li>• Kemba Live - Featured Performance</li>
                <li>• Columbus Americana Festival - Main Stage</li>
              </ul>
            </CardContent>
          </Card>
