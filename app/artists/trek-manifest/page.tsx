...
export default function TrekManifestPage() {
  const artist = {
    name: "Trek Manifest",
    location: "Columbus, OH",
    genres: ["Hip Hop"],
    bio: "Trek Manifest is a dynamic hip-hop artist from Columbus, Ohio, known for his powerful lyrics and engaging performances. With a unique style that blends traditional hip-hop elements with modern influences, Trek Manifest continues to make waves in the local music scene.",
    profile_picture: "/images/trek-manifest.jpg",
    social_links: [
      {
        platform: "Spotify",
        url: "https://open.spotify.com/artist/trek-manifest",
        followers: "1.8K",
      },
      {
        platform: "Instagram",
        url: "https://www.instagram.com/trekmanifest",
        followers: "3.2K",
      },
    ],
  }
          ...
          <Card className="bg-navy-light border-navy">
            ...
            <CardContent>
              <ul className="text-gray-300 space-y-2">
                <li>• Kemba Live - Opening Act</li>
                <li>• Newport Music Hall - Featured Performance</li>
                <li>• Local Hip-Hop Showcase - Headliner</li>
              </ul>
            </CardContent>
          </Card>
