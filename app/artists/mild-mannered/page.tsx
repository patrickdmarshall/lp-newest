...
export default function MildManneredPage() {
  const artist = {
    name: "Mild-Mannered",
    location: "Columbus, OH",
    genres: ["Rock"],
    bio: "Mild-Mannered is a rock band from Columbus, Ohio, known for their dynamic sound and engaging live performances. Despite their humble name, they deliver powerful rock music that showcases both technical skill and emotional depth, making them a standout act in the local scene.",
    profile_picture: "/images/mild-mannered.jpeg",
    social_links: [
      {
        platform: "Spotify",
        url: "https://open.spotify.com/artist/mild-mannered",
        followers: "3.4K",
      },
      {
        platform: "Instagram",
        url: "https://www.instagram.com/mildmannered",
        followers: "4.9K",
      },
    ],
  }
          ...
          <Card className="bg-navy-light border-navy">
            ...
            <CardContent>
              <ul className="text-gray-300 space-y-2">
                <li>• The Basement - Rock Showcase</li>
                <li>• AR Music Bar - Featured Performance</li>
                <li>• Columbus Rock Series - Supporting Act</li>
              </ul>
            </CardContent>
          </Card>
