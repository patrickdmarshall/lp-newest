...
export default function RagsAndRichesPage() {
  const artist = {
    name: "RAGS AND RICHES",
    location: "Lexington, KY",
    genres: ["Pop"],
    bio: "RAGS AND RICHES is a dynamic pop duo from Lexington, Kentucky, known for their infectious energy and catchy melodies. With a sound that blends contemporary pop with classic influences, they create music that's both modern and timeless, establishing themselves as rising stars in the pop scene.",
    profile_picture: "/images/ragsriches.jpeg",
    social_links: [
      {
        platform: "Spotify",
        url: "https://open.spotify.com/artist/rags-and-riches",
        followers: "6.2K",
      },
      {
        platform: "Instagram",
        url: "https://www.instagram.com/ragsandriches",
        followers: "9.1K",
      },
    ],
  }
          ...
          <Card className="bg-navy-light border-navy">
            ...
            <CardContent>
              <ul className="text-gray-300 space-y-2">
                <li>• Lexington Music Festival - Headliner</li>
                <li>• Kentucky Pop Showcase - Featured Performance</li>
                <li>• Louisville Music Hall - Supporting Act</li>
              </ul>
            </CardContent>
          </Card>
