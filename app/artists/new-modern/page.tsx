...
export default function NewModernPage() {
  const artist = {
    name: "New Modern",
    location: "Columbus, OH",
    genres: ["Alternative"],
    bio: "New Modern is an alternative rock band from Columbus, Ohio, known for their fresh take on the alternative genre. With a sound that combines classic alternative elements with contemporary influences, New Modern creates music that feels both familiar and innovative, establishing themselves as an exciting new voice in the Columbus music scene.",
    profile_picture: "/images/NEWMODERN-5-31-25-24.jpeg",
    social_links: [
      {
        platform: "Spotify",
        url: "https://open.spotify.com/artist/new-modern",
        followers: "2.4K",
      },
      {
        platform: "Instagram",
        url: "https://www.instagram.com/newmodern",
        followers: "3.7K",
      },
    ],
  }
          ...
          <Card className="bg-navy-light border-navy">
            ...
            <CardContent>
              <ul className="text-gray-300 space-y-2">
                <li>• The Basement - Debut Performance</li>
                <li>• AR Music Bar - Featured Set</li>
                <li>• Columbus Alternative Showcase - Rising Artist Spotlight</li>
              </ul>
            </CardContent>
          </Card>
