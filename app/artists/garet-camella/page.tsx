...
export default function GaretCamellaPage() {
  const artist = {
    name: "Garet Camella",
    location: "Los Angeles, CA",
    genres: ["Indie"],
    bio: "Garet Camella is an indie artist from Los Angeles, California, known for his introspective songwriting and distinctive sound. With a style that blends indie rock with folk influences, Garet creates music that's both personal and universally relatable, establishing himself as a unique voice in the indie scene.",
    profile_picture: "/images/garet-camella.jpeg",
    social_links: [
      {
        platform: "Spotify",
        url: "https://open.spotify.com/artist/garet-camella",
        followers: "4.7K",
      },
      {
        platform: "Instagram",
        url: "https://www.instagram.com/garetcamella",
        followers: "7.1K",
      },
    ],
  }
          ...
          <Card className="bg-navy-light border-navy">
            ...
            <CardContent>
              <ul className="text-gray-300 space-y-2">
                <li>• The Troubadour - Featured Performance</li>
                <li>• Hotel Cafe - Acoustic Set</li>
                <li>• LA Indie Showcase - Headliner</li>
              </ul>
            </CardContent>
          </Card>
