...
const venue = {
  ...
  description:
    "An intimate underground venue known for showcasing emerging talent and established acts in a cozy, acoustic-friendly setting.",
  image: "/images/the-basement-new.jpg",
  capacity: 300,
  genres: ["Indie", "Folk", "Alternative", "Acoustic"],
  amenities: ["Sound System", "Lighting", "Green Room", "Bar"],
  photos: ["/images/the-basement-new.jpg"],
}
