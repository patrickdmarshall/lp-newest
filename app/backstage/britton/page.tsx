...
import { ArrowLeft, Music, Megaphone, Target, Instagram, Linkedin, Mail } from "lucide-react";
        ...
        <div className="relative h-[500px] md:h-[600px] bg-navy-dark flex flex-col justify-end items-center p-6 text-center">
          ...
          <div className="relative z-10 text-white max-w-4xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              <h1 className="text-4xl md:text-6xl font-bold mb-2 font-syne">Britton</h1>
              <p className="text-xl text-gray-300 mb-6 font-semibold text-orange">Brand President & Co-Founder</p>

              <div className="flex justify-center gap-4">
                <Link href="https://www.instagram.com/britton/" target="_blank" rel="noopener noreferrer">
                  <Button variant="ghost" size="icon" className="text-white hover:text-orange">
                    <Instagram className="h-6 w-6" />
                  </Button>
                </Link>
                <Link href="https://www.linkedin.com/in/britton/" target="_blank" rel="noopener noreferrer">
                  <Button variant="ghost" size="icon" className="text-white hover:text-orange">
