            ...
            <div className="max-w-4xl mx-auto space-y-8">
                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-start md:items-center">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-300 text-lg leading-relaxed">
                          Powering Level Play's technical infrastructure with
                          world-class engineering expertise from the West Coast.
                        </p>
                      </div>
                    </div>
                  </CardContent>
                ...
                <Card className="bg-navy-light border-navy hover:border-orange/50 transition-all duration-300">
                  ...
                  <CardContent className="space-y-4">
                    <p className="text-gray-300 leading-relaxed text-lg">
                      As Senior Engineer at Level Play, Patrick brings
                      world-class technical expertise from Los Angeles to power
                      the platform that connects Columbus's music community.
                      With extensive experience in full-stack development and
                      system architecture, Patrick ensures Level Play operates
                      at peak performance.
                    </p>
                    <p className="text-gray-300 leading-relaxed text-lg">
                      Patrick's remote collaboration from the West Coast
                      demonstrates Level Play's commitment to accessing top
                      talent regardless of location. His technical leadership
                      and innovative solutions drive the platform's reliability,
              ...
              >
                <Card className="bg-navy-light border-navy hover:border-orange/50 transition-all duration-300">
                  ...
                  <CardContent className="space-y-6">
                    <p className="text-gray-300 leading-relaxed text-lg">
                      Patrick's engineering excellence ensures that Level Play
                      can handle the demands of a growing music community while
                      maintaining the speed and reliability that users expect.
                      His attention to detail and commitment to best practices
                      make the platform a joy to use for both artists and
                      venues.
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="p-6 bg-navy/50 rounded-xl border border-navy-light">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <h5 className="text-orange font-semibold">
                            Platform Performance
                          </h5>
                        </div>
                        <p className="text-gray-300 text-sm">
                          Optimized for sub-second load times and high
                          availability, ensuring artists never miss an
                          opportunity.
                        </p>
                      </div>
                      <div className="p-6 bg-navy/50 rounded-xl border border-navy-light">
                        ...
                        <p className="text-gray-300 text-sm">
                          Enterprise-grade security protecting sensitive artist
                          and venue data with industry best practices.
                        </p>
                      </div>
                    </div>
                  </CardContent>
