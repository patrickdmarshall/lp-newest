...
import { Home, User, Calendar, FileText, Settings, Menu, LogOut, Music } from "lucide-react"
  ...
  const SidebarContent = () => (
    <div className="flex h-full flex-col">
      ...
      <div className="border-t border-[#2a2f46] p-4">
        <Button variant="ghost" className="w-full justify-start text-gray-300 hover:bg-[#2a2f46] hover:text-white">
  ...
  return (
    <>
      ...
      <Sheet>
        ...
        <SheetContent side="left" className="w-64 p-0 bg-[#1a1f36] border-[#2a2f46]">
          <SidebarContent />
        </SheetContent>
      </Sheet>
    </>
